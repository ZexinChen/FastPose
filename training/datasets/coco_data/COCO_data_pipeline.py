...
class Cocokeypoints(Dataset):
    ...
    def add_middlePoint(self,points):
        coco_ann = {'nose':0, 'l eye':1, 'r eye':2, 'l ear':3, 'r ear':4, 
                'l shoulder':5, 'r shoulder':6, 'l elbow':7, 'r elbow':8, 
                'l wrist':9, 'r wrist':10, 'l hip':11, 'r hip':12, 
                'l knee':13, 'r knee':14, 'l ankle':15, 'r ankle':16,'neck':17}
        middlePoint_list = [ 
            [coco_ann['nose'],coco_ann['l eye']], [coco_ann['nose'],coco_ann['r eye']], 
            [coco_ann['l eye'],coco_ann['l ear']], [coco_ann['r eye'],coco_ann['r ear']], 
            [coco_ann['neck'],coco_ann['l shoulder']], [coco_ann['neck'],coco_ann['nose']],
            [coco_ann['l shoulder'],coco_ann['l elbow']], [coco_ann['r shoulder'],coco_ann['r elbow']],
            [coco_ann['l elbow'],coco_ann['l wrist']], [coco_ann['r elbow'],coco_ann['r wrist']], 
            [coco_ann['l hip'],coco_ann['r hip']],  
            [coco_ann['l hip'],coco_ann['l shoulder']], [coco_ann['r hip'],coco_ann['r shoulder']], 
            [coco_ann['l hip'],coco_ann['l knee']], [coco_ann['r hip'],coco_ann['r knee']], 
            [coco_ann['l knee'],coco_ann['l ankle']], [coco_ann['r knee'],coco_ann['r ankle']], 
            [coco_ann['neck'],coco_ann['r shoulder']], 
        ]
        for i in range(len(middlePoint_list)) :
            middlePoint = middlePoint_list[i]
            right_shoulder = points[middlePoint[0], :]
            left_shoulder = points[middlePoint[1], :]
    ...
    def add_neck(self, meta):
        ...
        meta['joint_self'] = self.add_middlePoint(meta['joint_self'])
        ...
        for i in range(meta['numOtherPeople']):
            ...
            single_p = self.add_middlePoint(single_p)
    ...
    def get_ground_truth(self, meta, mask_miss):
        ...
        heatmaps = np.zeros((int(grid_y), int(grid_x), 37))
        ...
        heat_mask = np.repeat(mask_miss, 37, axis=2)
        ...
        # background
        heatmaps[:, :, 36] = np.maximum(1 - np.max(heatmaps[:, :, :36], axis=2), 0.)

        return heat_mask, heatmaps, None, None
